...
void UpperMonitor_Sent_Choose(float * data)
{
  ...
  for(i=0;i<Sent_Data_Num;i++)
  {
    ...
    {
      /* 以下部分用于观察参数曲线 */
//			case 0: data[i]= PackFromVisionUnion.PackFromVision.yawData;
//          break;
//      case 1: data[i]= Pitch_Yaw.yawAngle.Current;
//          break;
//			case 0: data[i]= Pitch_Yaw.yawAngle.Target;
//          break;
//      case 1: data[i]= Pitch_Yaw.yawAngle.Current;
//          break;
//			case 2: data[i]= Pitch_Yaw.yawSpeed.Target;
//				break;
//			case 3: data[i]= Pitch_Yaw.yawSpeed.Current;
//				break;
//			case 4: data[i]= Pitch_Yaw.pitchAngle.Target-3500.0;
//          break;
//      case 5: data[i]= Pitch_Yaw.pitchAngle.Current-3500.0;
//          break;
//			case 6: data[i]= Pitch_Yaw.pitchSpeed.Target;
//				break;
//			case 7: data[i]= Pitch_Yaw.pitchSpeed.Current;
//				break;
//      case 0: data[i]= Pitch_Yaw.yawAngle.Current;
//          break;
//      case 1: data[i]= Pitch_Yaw.yawAngle.Target;
//          break;
//			case 2: data[i]= Pitch_Yaw.yawSpeed.I_Term;
//				break;
//			case 3: data[i]= Pitch_Yaw.yawSpeed.P_Term;
//				break;
//			case 4: data[i]= Pitch_Yaw.yawSpeed.Target;
//				break;
//			case 5: data[i]= Pitch_Yaw.yawSpeed.Current;
//				break;
//			case 6: data[i]= Pitch_Yaw.yawSpeed.Out;
//				break;
			
			case 0: data[i]= Pitch_Yaw.pitchAngle.Current;
					break;
			case 1: data[i]= Pitch_Yaw.pitchAngle.Target;
					break;
			case 2: data[i]= Pitch_Yaw.pitchSpeed.I_Term;
				break;
			case 3: data[i]= Pitch_Yaw.pitchSpeed.P_Term;
				break;
			case 4: data[i]= Pitch_Yaw.pitchSpeed.Target;
				break;
			case 5: data[i]= Pitch_Yaw.pitchSpeed.Current;
				break;
			case 6: data[i]= Pitch_Yaw.pitchSpeed.Out;
				break;
...
void PARAMETER_MODIFICATION(uint8_t * PARAMETER)
{
  ...
  {
    /* 以下部分用于修改参数内容 */
//    case 0x00: a=PARAMETER_Change_float(PARAMETER+1);
//         break;
//		 case 0x01: b=PARAMETER_Change_float(PARAMETER+1);
//         break;
//		 case 0x02: Pitch_Yaw.yawAngle.Kp=PARAMETER_Change_float(PARAMETER+1);
//         break;
//		 case 0x03: Pitch_Yaw.yawSpeed.Kp=PARAMETER_Change_float(PARAMETER+1);
//         break;
//		case 0x04: Pitch_Yaw.yawAngle.Target=PARAMETER_Change_float(PARAMETER+1);
//         break;
     default:break;
	/* 以上部分用于修改参数内容 */
  }
