...
class C_Shoot
{
	public:
	  ...
	  float friSpeed_15 = 3800  ,friSpeed_18 = 4190, friSpeed_22 = 4650, friSpeed_30 = 7400;		//15_3900ÐÂ/3740¾É			6500	4300/17	//Ä¦²ÁÂÖ×ªË
		float bulletSpeed ,lastBulletSpeed,heat,heatRf;
		int16_t cnt,delayCnt,friWheelDelay,bulletBayDelay; 
		int16_t period = 65;				//Éä»÷ÖÜÆÚ
		int16_t coolingRate = 100,heatLimit = 120,shooterHeat,index;
		int8_t maxSpeed = 15;						//×î¸ß³õËÙ¶È
