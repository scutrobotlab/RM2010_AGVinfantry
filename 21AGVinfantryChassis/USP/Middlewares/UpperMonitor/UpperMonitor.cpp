...
void UpperMonitor_Sent_Choose(float * data)
{
  ...
  for(i=0;i<Sent_Data_Num;i++)
  {
    ...
    {
      /* 以下部分用于观察参数曲线 */
			case 0: data[i]= (float)SourceManage.power.pow_motor;
          break;
			case 1: data[i]= (float)Referee.GameRobotState.classis_power_limit;
          break;
			case 2: data[i]= (float)Referee.PowerHeatData.chassis_power_buffer;
          break;
			case 3: data[i]= (float)SourceManage.capObj.Voltage;
          break;
			case 4: data[i]= (float)Referee.PowerHeatData.chassis_power;
          break;
			case 5: data[i]= (float)SourceManage.power.pow_In;
          break;
			case 6: data[i]= (float)SourceManage.power.pow_Charge;
          break;
//			case 5: data[i]= (float)auto_infantry.movingMotor[0].Current;
//          break;
//			case 6: data[i]= (float)auto_infantry.movingMotor[0].Target;
//          break;
//			case 7: data[i]= (float)auto_infantry.movingTarget[2];
//          break;
      default:break;
	  /* 以上部分用于观察参数曲线 */
    }
...
void PARAMETER_MODIFICATION(uint8_t * PARAMETER)
{
  ...
  {
    /* 以下部分用于修改参数内容 */
//    case 0x00: speed_test_error[0] =PARAMETER_Change_float(PARAMETER+1);
//          break;
//		case 0x01: speed_test_error[1] =PARAMETER_Change_float(PARAMETER+1);
//          break;
//		case 0x02: speed_test_error[2] =PARAMETER_Change_float(PARAMETER+1);
//          break;
     default:break;
	/* 以上部分用于修改参数内容 */
  }
